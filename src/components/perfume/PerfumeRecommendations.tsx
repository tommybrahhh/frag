...
export default function PerfumeRecommendations({ recommendationCategories }: PerfumeRecommendationsProps) {
      ...
      {recommendationCategories.map(category => (
        <section key={category.type}>
          ...
          {category.recommendations && category.recommendations.length > 0 ? (
            ...
            // This is the new "empty state" UI, fulfilling the user's request for UI resilience.
