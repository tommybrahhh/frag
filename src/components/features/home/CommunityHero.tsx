        ...
        <div className="flex flex-col justify-center">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              <div className="flex h-2 w-2 rounded-full bg-stone-400 shadow-[0_0_8px_rgba(168,162,158,0.5)] animate-pulse" />
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-stone-400">The Scent Community</span>
            </div>

            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[1.1] mb-8">
              Where Every <br />
              <span className="italic text-stone-400">Fragrance Has a Story.</span>
            </h1>
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <Link 
                href="/search"
                className="px-8 py-4 bg-white text-stone-900 rounded-full font-bold text-xs uppercase tracking-widest hover:bg-stone-200 transition-all active:scale-95"
              >
                Explore Library
              </Link>
              <Link 
                href="/community"
                className="group px-8 py-4 bg-stone-800/50 backdrop-blur-md border border-white/10 text-white rounded-full font-bold text-xs uppercase tracking-widest hover:bg-white/10 transition-all flex items-center gap-2"
              >
  ...
  return (
    <div className="bg-white/5 backdrop-blur-md border border-white/10 p-5 rounded-2xl hover:bg-white/[0.08] transition-all duration-300 group">
      <div className="flex items-start gap-5">
        {/* Perfume Thumbnail */}
        <div className="relative w-14 h-14 bg-stone-50 rounded-xl overflow-hidden flex-shrink-0 shadow-lg">
          {item.perfume_image ? (
            <Image 
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="text-[10px] uppercase tracking-wider text-stone-400 font-bold mb-2">
            {item.type === 'review' ? 'Reviewed' : 'Commented'}
          </div>

          <div className="font-serif text-sm text-white mb-2 truncate group-hover:text-stone-300 transition-colors">
            {item.perfume_name}
          </div>
